    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_birth', models.DateField(auto_now_add=True, null=True, verbose_name='Doğum Tarihi')),
                ...
                ('date_of_death', models.DateField(auto_now_add=True, null=True, verbose_name='Ölüm Tarihi')),
                ...
                ('group_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.groupmodel', verbose_name='Grubu')),
            ],
            options={
                'verbose_name': 'Rehber',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('web_address', models.CharField(blank=True, max_length=200, null=True, verbose_name='Adresi')),
