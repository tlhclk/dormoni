...
class ReportFilterModel(models.Model):
    ...
    filter_type = models.CharField(verbose_name='Tipi', null=True, blank=True, max_length=50, choices=[('1', 'e'), ('2', 'ne'), ('3', 'gt'), ('4', 'gte'), ('5', 'lt'), ('6', 'lte'), ('7', 'in'), ('8', 'out'), ('9', 'limit'), ('10', 'last_in'), ('11', 'next_in'), ('12', 'order_by'),('13','sub_date')])
