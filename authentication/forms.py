...
class RegisterForm(forms.Form):
	...
	def save(self):
		...
		password = self.cleaned_data["password"]
		UserModel.objects.create(username=username,email=email,password=make_password(password),first_name=first_name,last_name=last_name,is_superuser=False,is_active=False,is_staff=False)
